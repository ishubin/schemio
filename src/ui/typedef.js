 ...
 * @property {String|undefined} eventLayerId - used for dynamically loaded components for event layer isolation
 * @property {SchemeContainer|undefined} componentSchemeContainer
 * @property {String|undefined} componentEventLayerId - the event bus id for all component items
