...
export default {
    ...
    shapeConfig: {
        ...
        args: {
            ...
            strokeSize  : {type: 'number', value: 0, name: 'Stroke size', min: 0, softMax: 100},
            showTitle   : {type: 'boolean', value: false, name: 'Title'},
            crop        : {type: 'crop-area', value: {x: 0, y: 0, w: 0, h: 0}, name: 'Crop', hidden: true},
            titleHeight : {type: 'number', value: 36, name: 'Title height', min: 0, softMax: 100, depends: {showTitle: true}},
    ...
    computed: {
        ...
        svgTitleFill() {
            return computeSvgFill(this.item.shapeProps.titleFill, `titlefill-pattern-${this.item.id}`);
        },
