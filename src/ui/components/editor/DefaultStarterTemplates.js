export const defaultStarterTemplates = [{
    name: 'Empty canvas',
    docUrl: null,
}, {
    name: 'Sankey diagram',
    ...
    name: 'Slide show',
    iconUrl: '/assets/starters/slide-show.svg',
    docUrl: '/assets/starters/slide-show.json',
}, {
    name: 'Frame-by-frame',
    iconUrl: '/assets/starters/frame-by-frame.svg',
    docUrl: '/assets/starters/frame-by-frame.json',
}];