        ...
        <div class="row">
            <div class="col-1">
                <div v-if="simplePadding" class="row padded centered gap">
                    ...
                    <number-textfield :value="padding" name="Padding" @changed="padding = $event" style="max-width: 150px;"/>
                </div>
                <div v-else class="row centered gap">
                    ...
                    <div class="col-1">
                        <div class="row padded centered gap">
                            <number-textfield :value="paddingLeft" name="Left" @changed="paddingLeft = $event"/>
                            <number-textfield :value="paddingTop" name="Top" @changed="paddingTop = $event"/>
                        </div>
                        <div class="row padded centered gap">
                            <number-textfield :value="paddingRight" name="Right" @changed="paddingRight = $event"/>
                            <number-textfield :value="paddingBottom" name="Bottom" @changed="paddingBottom = $event"/>
                        </div>
                    </div>
                </div>
            </div>
